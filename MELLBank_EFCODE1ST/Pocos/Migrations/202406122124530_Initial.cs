    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        current_id = c.Guid(nullable: false, identity: true, defaultValueSql: "newsequentialid()"),
            ...
            CreateTable(
                ...
                c => new
                    {
                        savings_id = c.Guid(nullable: false, identity: true, defaultValueSql: "newsequentialid()"),
                        account_number = c.String(),
                        creation_date = c.DateTime(nullable: false),
                        balance = c.Double(nullable: false),
                        branch_code = c.String(),
